...
public class newSale extends AppCompatActivity
{
    ...
    private EditText salePriceIncGST;
    ...
    private String GST = "";
    private String SalePriceIncGST = "";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        salePriceIncGST = (EditText) findViewById(R.id.salePriceIncGST);
        ...
        salePriceIncGST.setOnFocusChangeListener(new View.OnFocusChangeListener()
        {
            @Override
            public void onFocusChange(View view, boolean hasFocus)
            {
    ...
    {
        Intent goTODirectSale = new Intent(newSale.this, com.ganitum.com.activities.salesActivity.directSale.class);
        startActivity(goTODirectSale);
        finish();
    }

    private void invoiceDataSet(int flag)
    {
        if(!validateProductName() | !validateHSN() | !validateQuantity() | !validateSalePrice() | !validateUnit() |
                !validateSalePriceIncludingGst() | !validateGST())
        {
            return;
        }
        ...
        SalePriceIncGST = salePriceIncGST.getText().toString();
    ...
    {
        Intent goTOInvoice = new Intent(newSale.this, invoiceGenerator.class);
        goTOInvoice.putExtra("activity_name","newSale");
        ...
        goTOInvoice.putExtra("SalePriceIncGst",SalePriceIncGST);
    ...
    {
        if(!validateProductName() | !validateHSN() | !validateQuantity() | !validateSalePrice()
                | !validateUnit() | !validateGST())
        {
            return;
        }

        double totalPrice = Double.parseDouble(quantity.getText().toString().trim()) *
                Double.parseDouble(salePrice.getText().toString().trim()) *
                ((Double.parseDouble(gst.getText().toString().trim())+100.0) / 100.0);

        salePriceIncGST.setText(new DecimalFormat("##.##").format(totalPrice));
    }
    ...
    private Boolean validatePrice()
    {
        ...
        {
            salePrice.setError(getResources().getString(R.string.valid_price));
            return false;
        }
    ...
    private Boolean validateSalePriceIncludingGst()
    {
        if(String.valueOf(salePriceIncGST.getText()).isEmpty())
        {
            salePriceIncGST.setError(getResources().getString(R.string.non_empty_total_price));
            return false;
        }

        if(salePriceIncGST.getText().toString().trim().length() == 0)
        {
            salePriceIncGST.setError(getResources().getString(R.string.non_empty_total_price));
            return false;
        }
    ...
    private void openColorPickerDialog(boolean AlphaSupport)
    {
        AmbilWarnaDialog ambilWarnaDialog = new AmbilWarnaDialog(this, DefaultColor, AlphaSupport,
                new AmbilWarnaDialog.OnAmbilWarnaListener()
                {
                    ...
                    {
                        DefaultColor = ContextCompat.getColor(newSale.this, R.color.colorPrimary);
                        customerPicture.setImageDrawable(null);
                        makeBitmap(DefaultColor);
                    }
                });
